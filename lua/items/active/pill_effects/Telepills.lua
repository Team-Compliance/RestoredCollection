...
RestoredCollection:AddCallback(ModCallbacks.MC_POST_NEW_ROOM, NewTeleRoom)
...
RestoredCollection:AddCallback(ModCallbacks.MC_POST_NPC_RENDER, TeleportMonsterAnim)
