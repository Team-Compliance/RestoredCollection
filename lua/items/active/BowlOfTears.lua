...
if REPENTOGON then
	...
	RestoredItemsCollection:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, BowlOfTears.TearBowlCharge)
	RestoredItemsCollection:AddCallback(ModCallbacks.MC_POST_KNIFE_UPDATE, BowlOfTears.KnifeBowlCharge)
	RestoredItemsCollection:AddCallback(ModCallbacks.MC_POST_TEAR_UPDATE, BowlOfTears.TearUpdateBOT)
	RestoredItemsCollection:AddCallback(ModCallbacks.MC_POST_LASER_UPDATE, BowlOfTears.BrimstoneBowlCharge)
	RestoredItemsCollection:AddCallback(ModCallbacks.MC_POST_EFFECT_INIT, BowlOfTears.EpicBowlCharge, EffectVariant.ROCKET)
end
