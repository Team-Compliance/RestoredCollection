...
function IllusionModLocal:onUseBookOfIllusions(_, _, player, flags)
	...
	if flags & UseFlag.USE_NOANIM == 0 then
		player:AnimateCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_BOOK_OF_ILLUSIONS, "UseItem", "PlayerPickupSparkle")
	end
end
RestoredCollection:AddCallback(ModCallbacks.MC_USE_ITEM, IllusionModLocal.onUseBookOfIllusions, RestoredCollection.Enums.CollectibleType.COLLECTIBLE_BOOK_OF_ILLUSIONS)
