...
if CustomHealthAPI then
	...
	function ComplianceSunLocal:RevertToEternalHeart(pickup)
		if pickup.SubType == RestoredCollection.Enums.Pickups.Hearts.HEART_SUN then
			pickup:Morph(pickup.Type, PickupVariant.PICKUP_HEART, HeartSubType.HEART_ETERNAL, true, true)
		end
	end
	RestoredCollection:AddCallback(ModCallbacks.MC_POST_PICKUP_UPDATE, ComplianceSunLocal.RevertToEternalHeart, PickupVariant.PICKUP_HEART)
end