...
if CustomHealthAPI then
	...
	function ComplianceImmortalLocal:RevertToEternalHeart(pickup)
		if pickup.SubType == RestoredCollection.Enums.Pickups.Hearts.HEART_IMMORTAL then
			pickup:Morph(pickup.Type, PickupVariant.PICKUP_HEART, HeartSubType.HEART_ETERNAL, true, true)
		end
	end
	RestoredCollection:AddCallback(ModCallbacks.MC_POST_PICKUP_UPDATE, ComplianceImmortalLocal.RevertToEternalHeart, PickupVariant.PICKUP_HEART)
end