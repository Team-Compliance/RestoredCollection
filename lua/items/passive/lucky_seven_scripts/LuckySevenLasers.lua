...
RestoredItemsPack:AddCallback(ModCallbacks.MC_POST_LASER_INIT, LuckySevenLasers.OnLaserInit)
...
RestoredItemsPack:AddCallback(ModCallbacks.MC_POST_LASER_RENDER, LuckySevenLasers.OnLaserRender)
...
function LuckySevenLasers:OnEntityDamage(entity, _, flags, source)
    ...
    if not player:HasCollectible(RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_LUCKY_SEVEN) or
...
RestoredItemsPack:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, LuckySevenLasers.OnEntityDamage)