...
local function load()
    ...
    local function UpdateCustomRockExplosion(_,effect)
    ...
    CustomShockwaveAPI:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, UpdateCustomRockExplosion, EffectVariant.ROCK_EXPLOSION)
    --#endregion
    print("[".. CustomShockwaveAPI.Name .."]", "is loaded")
end

if CustomShockwaveAPI then
	if CustomShockwaveAPI.Version < localversion then
		...
		load()
		print("[".. CustomShockwaveAPI.Name .."]", "replaced with V" .. CustomShockwaveAPI.Version)
	end
