...
--Game Squid
EID:addTrinket(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "5% change to shoot slowing tear that leaves black puddle on impact")
EID:addTrinket(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "5% шанс выстрелить замедляющей слезой, которая оставляет черную лужу при столкновении", "Игровой кальмар", "ru")
EID:addTrinket(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "5% de disparar una lágrima ralentizada que deja un charco negro cuando impacta", "", "spa")
EID:addTrinket(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "5% de chance de disparar uma lágrima que desascelera e deixa uma poça preta no impacto", "Lula dos Games", "pt_br")
EID:addGoldenTrinketMetadata(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "↑ +3% on top for every trinket multiplier")
EID:addGoldenTrinketMetadata(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "↑ +3% дополнительно за каждый множитель брелка", nil, nil, "ru")
EID:addGoldenTrinketMetadata(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "↑ +3% cuando se usa con cualquier trinket de multiplicador", nil, nil, "spa")
EID:addGoldenTrinketMetadata(RestoredCollection.Enums.TrinketType.TRINKET_GAME_SQUID_TC, "↑ +3% de chance por cada multiplicador de trinkets", nil, nil, "pt_br")