...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_STONE_BOMBS, "Bombas colocadas agora explodem e criam ondas de pedra em 4 direções cardeais#As ondas de pedra podem causar dano aos inimigos, destruir objetos, e relevar salas sexretas#+5 Bombas", "Bombas de Pedra", "pt_br")
...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_BOWL_OF_TEARS, "Attire uma cacho de lágrimas#Cada lágrima atirada por Isaac aumenta a carga da barra de espaço por um", "Tigela de Lágrimas", "pt_br")
...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_DONKEY_JAWBONE, "Quando for atingido, esse item cause que você faça um ataque de giro, causando dano para inimigos próximos e bloqueando projéteis por uma duração curta", "Maxilar de Burro", "pt_br")

--Menorah
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_MENORAH, "Spawns a menorah familiar that causes Isaac's tears to be multiplied by the number of lit candles#Halves tear delay and then multiplies it by the sum of lit candles plus 1", "Menorah", "en_us")
...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_MENORAH, "Создает подсвечник, который заставляет слезы Исаака размножиться на количество зажжённых свечей#Уменьшает скорострельность, а затем умножает её на количество зажженных свечей плюс 1", "Менора", "ru")
...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_BOOK_OF_ILLUSIONS, BOIDescPt_Br, "Livro de Ilusões", "pt_br")
...
EID:addCollectible(RestoredCollection.Enums.CollectibleType.COLLECTIBLE_PILL_CRUSHER, PCDescPt_Br, "Triturador de Pílula", "pt_br")
