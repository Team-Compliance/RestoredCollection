...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_STONE_BOMBS,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_BLANK_BOMBS,
...
--Checked mate
Encyclopedia.AddItem({
	ID =RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_CHECKED_MATE,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_BOOK_OF_DESPAIR,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_BOWL_OF_TEARS,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_DONKEY_JAWBONE,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_MENORAH,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_DICE_BOMBS,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_ANCIENT_REVELATION,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_BETHS_HEART,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_BOOK_OF_ILLUSIONS,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_KEEPERS_ROPE,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_LUCKY_SEVEN,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_PACIFIST,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_PILL_CRUSHER,
...
--Safety bombs
Encyclopedia.AddItem({
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_SAFETY_BOMBS,
...
--Voodoo Pin
Encyclopedia.AddItem({
    ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_VOODOO_PIN,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_MAXS_HEAD,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_OL_LOPPER,
...
Encyclopedia.AddItem({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_PUMPKIN_MASK,
...
Encyclopedia.AddTrinket({
	ModName = "Compliance",
	Class = "Compliance",
	ID = RestoredItemsPack.Enums.TrinketType.TRINKET_GAME_SQUID,
...
for i = 0, 5 do
	Encyclopedia.AddItem({
		ModName = "Compliance",
		Class = "Compliance",
		ID = RestoredItemsPack.Enums.CollectibleType.COLLECTIBLE_LUNCH_BOX - i,
...
RestoredItemsPack.Enums.Wiki = Wiki