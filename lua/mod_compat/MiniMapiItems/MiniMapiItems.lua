...
for _,item in pairs(RestoredCollection.Enums.CollectibleType) do
    MiniMapiItemsAPI:AddCollectible(item, Collectibles, "CustomIcons", item - RestoredCollection.Enums.CollectibleType.COLLECTIBLE_STONE_BOMBS)
end